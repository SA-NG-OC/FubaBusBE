...
public interface DriverRouteAssignmentRepository extends JpaRepository<DriverRouteAssignment, Integer> {
    ...
    /**
     * Find all assignments by driver (Spring Data method)
     */
    List<DriverRouteAssignment> findByDriverDriverId(Integer driverId);

    /**
     * Find all assignments by route ordered by priority (Spring Data method)
     */
    List<DriverRouteAssignment> findByRouteRouteIdOrderByPriorityAsc(Integer routeId);
