...
public class AnalyticsController {
        ...
        public ResponseEntity<ApiResponse<DashboardSummaryRes>> getSummary(
                ...
                DashboardSummaryRes summary = analyticsService.getDashboardSummary(month, year);
        ...
        public ResponseEntity<ApiResponse<List<ChartDataRes>>> getWeeklyRevenue(
                ...
                List<ChartDataRes> data = analyticsService.getRevenueByDayOfWeek(month, year);
        ...
        public ResponseEntity<ApiResponse<List<ChartDataRes>>> getShiftRevenue(
                ...
                List<ChartDataRes> data = analyticsService.getRevenueByShift(month, year);
        ...
        public ResponseEntity<ApiResponse<Page<RouteAnalyticsRes>>> getTopRoutes(
                ...
                Page<RouteAnalyticsRes> routes = analyticsService.getRouteAnalytics(month, year, pageable);
